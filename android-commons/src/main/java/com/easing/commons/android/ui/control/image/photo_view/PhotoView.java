package com.easing.commons.android.ui.control.image.photo_view;
...
public class PhotoView extends AppCompatImageView {
    ...
    private final static int ROTATE_THRESHOLD = 20;
    private final static int DEFAULT_ANIMATE_DURATION = 200;
    private final static float DEFAULT_MAX_SCALE_LEVEL = 3.0f;
    ...
    private void init() {
        ...
        mMinRotate = ROTATE_THRESHOLD;
        mAnimaDuring = DEFAULT_ANIMATE_DURATION;
        mMaxScale = DEFAULT_MAX_SCALE_LEVEL;
    }
     ...
     * 设置动画的持续时间
     */
    public void animateDuration(int during) {
        mAnimaDuring = during;
    }
     ...
     * 设置最大可以缩放的倍数
     */
    public void maxScale(float maxScale) {
        mMaxScale = maxScale;
    }
